...
> = {
  ...
  DEACTIVATED: { bg: "bg-gray-100", text: "text-gray-800" },
};
...
export interface AdminUser {
  indexId: number;
  userEmail: string;
  accountStatus: UserStatus; // Enum 값 (ACTIVE, SUSPENDED, DEACTIVATED)
  createDateTime: string; // ISO 8601 형식 문자열
}
