...
const genreTagMap = {
  "액션/스릴러": ["격투기", "다크히어로", "무협/사극", "밀리터리", "범죄", "서바이벌", "스릴러", "헌터물", "히어로", "아포칼립스", "좀비", "이능력배틀물", "최강자전", "힘숨찐"],
  "로맨스": ["고자극로맨스", "구원서사", "계략여주", "계약연애", "까칠남", "러블리", "로맨스", "비밀연애", "사내연애", "선결혼후연애", "소꿉친구", "연상연하", "아이돌연애", "짝사랑", "친구>연인", "캠퍼스로맨스", "학원로맨스", "전남친", "재회", "집착물", "직진남", "후회물"],
  "일상/힐링": ["2030연애", "동물", "동아리", "음식&요리", "일상", "직업드라마", "힐링", "육아물", "음악", "인플루언서"],
  "개그/코믹": ["개그", "로맨스코미디", "공감성수치", "병맛", "4차원", "병맛개그", "황당설정", "패러디"],
  "판타지/이세계": ["SF", "게임판타지", "다크판타지", "동양풍판타지", "로판", "몬스터", "세계관", "슈퍼스트링", "이능력배틀물", "이세계", "인외존재", "차원이동", "환골탈태", "회귀", "판타지", "판무", "퓨전사극"],
  "감성/드라마": ["감성", "감성드라마", "성장물", "성장드라마", "의학드라마", "청춘로맨스", "현실로맨스", "레트로", "레드스트링", "하이퍼리얼리즘", "궁중로맨스", "역사물", "재벌"],
  "학원/청춘": ["하이틴", "학원로맨스", "학원물", "청춘로맨스", "동아리", "짝사랑", "친구>연인", "캠퍼스로맨스"],
  "오컬트/서스펜스": ["감염", "괴담", "사이비종교", "서스펜스", "스릴러", "오컬트", "피카레스크", "블루스트링"],
  "엔터테인먼트/아이돌": ["아이돌", "아이돌연애", "연예계", "드라마&영화 원작웹툰", "영화원작웹툰", "프리퀄", "스핀오프", "소설원작"],
  "기타/특이": ["고인물", "성별반전", "세계관", "4차원", "병맛", "인외존재", "힘숨찐"]
};
