...
const SearchBar = () => {
  ...
  return (
      <div className="fixed top-0 left-3/5 transform -translate-x-1/2 w-96 z-50">
        {/* 고정된 검색 입력창 */}
        ...
        {/* 검색 결과 */}
        {results.length > 0 && (
            <ul className="w-96 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
